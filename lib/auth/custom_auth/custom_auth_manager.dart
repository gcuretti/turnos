...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    turnosAuthUserSubject.add(
      TurnosAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<TurnosAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  TurnosAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = TurnosAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    turnosAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
